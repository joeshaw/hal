 ...
 */
void
visit_class_device_v4l (const char *path,
			struct sysfs_class_device *class_device)
{
	...
	/* Ask udev about the device file if we are probing.. otherwise we'll
	 * just receive a dbus message from udev later */
	dev_file[0] = '\0';
	if (is_probing) {
		int i;
 ...
 */
static void
visit_class_device_v4l_got_sysdevice (HalDevice * sysdevice,
 ...
 */
void
linux_class_v4l_detection_done ()
{
}
